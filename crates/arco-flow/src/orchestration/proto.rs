...
use crate::orchestration::events::{
    ...
    RunRequest, SensorEvalStatus, SourceRef, TaskDef, TaskOutcome, TickStatus, TimerType,
...
fn event_data_to_proto(
    ...
    Ok(match data {
        ...
        OrchestrationEventData::TaskFinished {
            ...
            partial_progress_json: partial_progress_json.clone(),
    ...
    Ok(match event {
        ...
        orchestration_event_envelope::Event::TaskFinished(event) => {
            ...
            OrchestrationEventData::TaskFinished {
                ...
                partial_progress_json: event.partial_progress_json.clone(),
