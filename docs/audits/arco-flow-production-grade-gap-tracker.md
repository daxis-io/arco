...
| GT-011 | P1 | HYGIENE | Evidence docs appear stale/contradict code (example: flow metrics label claims). | `docs/catalog-metastore/evidence/2026-01-06-audit-review.md:42`, `crates/arco-flow/src/metrics.rs:90` | Refresh evidence docs or mark them time-scoped; ensure evidence references remain repo-correct. | Updated evidence with correct paths/claims; optional CI checks. |  |  |  |
