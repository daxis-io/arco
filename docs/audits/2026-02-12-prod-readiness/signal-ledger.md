...
| `delta-format-canonicalization` | `delta|iceberg|parquet` canonicalization + unknown format rejection | `release_evidence/2026-02-18-delta-primary-cutover/ci/delta-format-validation.txt` | Passed (2026-02-19) |
...
| `sdk-delta-default` | Python SDK `IoConfig.format` default is `delta` | `release_evidence/2026-02-18-delta-primary-cutover/sdk/python-default-format.txt` | Passed (2026-02-19: verified under Python 3.11 using `uv run --python 3.11 --extra dev pytest ...`) |
