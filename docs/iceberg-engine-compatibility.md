...
spark.sql.catalog.arco.header.X-Arco-Tenant=<tenant-id>
spark.sql.catalog.arco.header.X-Arco-Workspace=<workspace-id>
...
iceberg.rest-catalog.additional-headers.X-Arco-Tenant=<tenant-id>
iceberg.rest-catalog.additional-headers.X-Arco-Workspace=<workspace-id>
```
...
catalog = load_catalog(
    ...
    **{
        ...
        "header.X-Arco-Tenant": "<tenant-id>",
        "header.X-Arco-Workspace": "<workspace-id>",
...
curl -H "Authorization: Bearer <token>" \
     -H "X-Arco-Tenant: <tenant>" \
     -H "X-Arco-Workspace: <workspace>" \
