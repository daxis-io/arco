...
def asset(
    ...
    *,
    ...
    def decorator(fn: Callable[P, R]) -> Callable[P, R]:
        ...
        # Attach metadata
        wrapper.__arco_flow_asset__ = True  # type: ignore[attr-defined]
        wrapper.__arco_flow_key__ = asset_key  # type: ignore[attr-defined]
        wrapper.__arco_flow_definition__ = definition  # type: ignore[attr-defined]
