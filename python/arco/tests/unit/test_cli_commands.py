...
class TestDeployCommand:
    ...
    def test_deploy_dry_run_no_assets(self, tmp_path: Path, monkeypatch: MonkeyPatch) -> None:
    ...
    def test_deploy_dry_run_with_assets(self, tmp_path: Path, monkeypatch: MonkeyPatch) -> None:
    ...
    def test_deploy_writes_manifest_file(self, tmp_path: Path, monkeypatch: MonkeyPatch) -> None:
...
class TestValidateCommand:
    ...
    def test_validate_no_assets(self, tmp_path: Path, monkeypatch: MonkeyPatch) -> None:
    ...
    def test_validate_valid_assets(self, tmp_path: Path, monkeypatch: MonkeyPatch) -> None:
...
class TestInitCommand:
    ...
    def test_init_creates_project(self, tmp_path: Path, monkeypatch: MonkeyPatch) -> None:
