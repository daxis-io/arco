...
|---:|---|---|---|---|---|
| 0 | Plan coherence & architecture | GO | None (ADR-first policy; plans internal) | `evidence/gate-0/` | See `release_evidence/2025-12-30-catalog-mvp/gate-0/` |
...
| 2 | Storage, manifests & correctness | NO-GO | P0: Search anti-entropy is derived (no listing) | `evidence/gate-2/` | See `findings/gate-2-findings.md`; evidence index: `evidence/gate-2/00-evidence-index.md` |
