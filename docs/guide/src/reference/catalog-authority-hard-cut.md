...
of 2026-09-23 a cron-driven `arco-control-store-worker` job runs the drain,
layout maintenance, and GC on a schedule, but that cadence does not satisfy
the 10 s p99 projection-lag objective.
