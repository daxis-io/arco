...
#[openapi(
    ...
    paths(
        ...
        crate::routes::orchestration::upsert_schedule,
        crate::routes::orchestration::enable_schedule,
        crate::routes::orchestration::disable_schedule,
    ...
    components(
        schemas(
            ...
            crate::routes::orchestration::SensorEvalStatusFilter,
            ...
            crate::routes::orchestration::ListSensorEvalsQuery,
